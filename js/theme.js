 ...
 * Include this at the end of any page to add theme toggle
 */
(function() {
  ...
  // Wire up existing toggle if present
  var existingToggle = document.getElementById('tt');
  if (existingToggle) {
