window.CRYPTO3D_PUBLIC_EQUITY = {
  ...
  "source_policy": {
    ...
    "chain_first": "能从链上直接重建的执行金额，必须使用官方节点、RPC、API、合约事件、协议地址或原始账本作为主值。",
    "official_second": "链上不可得或业务天然在链下时，使用项目官方公告、报告、治理执行记录、官方仪表盘或审计材料。",
    "third_party_last": "DefiLlama、Token Terminal、Dune 等第三方只作兜底或交叉检查；必须标记为估算，不得覆盖链上或官方证据。",
    "conflict_policy": "来源冲突时不取平均；保留链上主值、记录差异并触发人工复核。链上时点余额、累计成本和部分窗口不得冒充 TTM。"
  },
  "expense_policy": {
  ...
  "coverage": {
    ...
    "net_income_count": 18,
    "price_to_earnings_count": 17,
    "dividends_count": 12,
    "repurchases_count": 17,
  ...
  "protocols": [
    {
      ...
      "provenance": {
        ...
        "evidence_boundary": "证据优先级为链上一手数据、官方披露、第三方兜底。第三方聚合值不能覆盖链上或官方冲突，也不能在一手账本未闭合时冒充已核实 TTM。"
      },
      "null_reasons": {
    ...
    },
    {
      ...
      "chain_diagnostics": {
        ...
        "observed_at": "2026-07-24T20:06:40.769Z",
        "ttm_window": {
          "start_inclusive": "2025-07-24T20:06:40.769Z",
          "end_exclusive": "2026-07-24T20:06:40.769Z",
          "expected_days": 365
        },
        "assistance_fund": {
          "address": "0xfefefefefefefefefefefefefefefefefefefefe",
          "hype_balance": 46016123.92473923,
          "entry_ntl_usd": 1210093629.0637374,
          "token_index": 150,
          "source": "Hyperliquid official info API: spotClearinghouseState",
          "source_url": "https://api.hyperliquid.xyz/info",
          "semantic_limit": "Point-in-time account state. entryNtl is cumulative position cost, not TTM purchase cash or Protocol Earnings."
        },
        "fills_window": {
          "all_rows": 16693,
          "hype_buy_rows": 16646,
          "observed_start": "2026-06-15T17:07:40.177Z",
          "observed_end": "2026-07-24T20:05:42.620Z",
          "hype_bought": 796262.37999999,
          "purchase_consideration_usd": 52008479.56,
          "complete_for_ttm": false,
          "source": "Hyperliquid official info API: userFillsByTime",
          "source_url": "https://api.hyperliquid.xyz/info",
          "api_page_limit": 2000,
          "api_documented_retention_limit": 10000,
          "documentation_url": "https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint",
          "semantic_limit": "The official documentation states a 2,000-fill response cap and a latest-10,000 retention limit. Paginated rows are deduplicated by trade id, but the observed window remains a partial chain diagnostic unless it spans the full TTM and reconciles opening/closing balances and transfers."
        },
        "official_mechanism": {
          ...
          "summary": "Official documentation states that the Assistance Fund converts trading fees to HYPE automatically and burns the acquired HYPE. Complete historical reconstruction requires primary node data beyond the limited account fills endpoint."
        },
        "canonical_decision": {
          "revenue_ttm_usd": "PENDING",
          "protocol_earnings_ttm_usd": "PENDING",
          "repurchases_ttm_usd": "PENDING",
          "cash_pe": "PENDING",
          "reason": "Chain-first policy blocks third-party or legacy snapshot fallback until the official TTM fee and Assistance Fund ledgers are complete and reconciled."
        }
      },
      "metric_meta": {
        "market_cap": {
        ...
        "revenue": {
          "state": "PENDING",
          "block_fallback": true,
          "window": "[2025-07-24T19:59:00.639Z,2026-07-24T19:59:00.639Z)",
          "source": "Hyperliquid official info API chain diagnostics; P13-hype formal reviewed research package",
          "source_url": null,
          "as_of": "2026-07-24T19:59:00.639Z",
          "confidence": "high",
          "source_tier": "CHAIN_PRIMARY",
          "reason": "Chain-first policy withdraws the legacy $792,146,570 third-party/snapshot proxy. Complete HyperCore fee, rebate, HLP, builder and deployer ledgers are not yet closed for the exact TTM window; DefiLlama is retained only as a cross-check.",
          "display_note": "TTM 候选"
        },
        "direct_economic_costs": {
          "state": "PENDING",
          "window": "[2025-07-23T00:00:00Z,2026-07-23T00:00:00Z)",
          "source": "Hyperliquid official fee documentation; P13-hype formal reviewed research package",
          "source_url": null,
          "as_of": "2026-07-23T21:16:34Z",
          "confidence": "high",
        ...
        "realized_protocol_losses": {
          "state": "PENDING",
          "window": "[2025-07-23T00:00:00Z,2026-07-23T00:00:00Z)",
          "source": "Hyperliquid official mechanism documentation; P13-hype formal reviewed research package",
          "source_url": null,
          "as_of": "2026-07-23T21:16:34Z",
          "confidence": "medium",
          "source_tier": "OFFICIAL_PRIMARY",
        ...
        "protocol_earnings": {
          ...
          "block_fallback": true,
          "window": "[2025-07-23T00:00:00Z,2026-07-23T00:00:00Z)",
          "source": "Derived only after chain-first Hyperliquid revenue, direct-cost and realized-loss ledgers close",
          "source_url": null,
          "as_of": "2026-07-23T21:16:34Z",
          "confidence": "high",
          "source_tier": "CHAIN_PRIMARY",
          "reason": "The PRD permits HYPE Cash P/E only when protocol revenue and costs close; AF balances, entryNtl and HLP PnL are not substitutes for earnings.",
          "display_note": "证据待补"
        },
        "price_to_sales": {
          "state": "PENDING",
        ...
        "dividends": {
          "state": "ZERO",
          "window": "[2025-07-23T00:00:00Z,2026-07-23T00:00:00Z)",
          "source": "Hyperliquid official fee and staking documentation; P13-hype formal reviewed research package",
          "source_url": null,
          "as_of": "2026-07-23T21:16:34Z",
          "confidence": "high",
          "source_tier": "OFFICIAL_PRIMARY",
        ...
        "repurchases": {
          ...
          "block_fallback": true,
          "window": "[2025-07-24T19:59:00.639Z,2026-07-24T19:59:00.639Z)",
          "source": "Hyperliquid official info API userFillsByTime and spotClearinghouseState",
          "source_url": null,
          "as_of": "2026-07-24T19:59:00.639Z",
          "confidence": "high",
          "source_tier": "CHAIN_PRIMARY",
          "reason": "Official API diagnostics currently cover only a partial 2026-06-15 through 2026-07-24 fill window, not a complete TTM ledger. The generated chain diagnostic records the current partial amount; the legacy $918.60M DefiLlama-mapped estimate is withdrawn and retained only as a cross-check.",
          "display_note": "证据待补"
        },
        "fee_burns": {
          "state": "PENDING",
          "window": "[2025-07-23T00:00:00Z,2026-07-23T00:00:00Z)",
          "source": "Hyperliquid official token and HyperEVM documentation; P13-hype formal reviewed research package",
          "source_url": null,
          "as_of": "2026-07-23T21:16:34Z",
          "confidence": "high",
          "source_tier": "OFFICIAL_PRIMARY",
          "reason": "AF holdings, direct raw-supply reductions, HIP-1 burns and HyperEVM fee burns require separate event-time ledgers. Point-in-time supply reduction is not substituted for TTM fee-funded burn value.",
          "display_note": "证据待补"
        },
        "dividend_yield": {
          "state": "ZERO",
      ...
      "provenance": {
        ...
        "candidate_file": "data/candidates/phase1-p10-p18.json",
        "metric_sources": [
          "Hyperliquid official info API chain diagnostics; P13-hype formal reviewed research package",
          "Hyperliquid official fee documentation; P13-hype formal reviewed research package",
          "Hyperliquid official mechanism documentation; P13-hype formal reviewed research package",
          "Derived only after chain-first Hyperliquid revenue, direct-cost and realized-loss ledgers close",
          "Hyperliquid official fee and staking documentation; P13-hype formal reviewed research package",
          "Hyperliquid official info API userFillsByTime and spotClearinghouseState",
          "Hyperliquid official token and HyperEVM documentation; P13-hype formal reviewed research package"
        ],
        "evidence_boundary": "证据优先级为链上一手数据、官方披露、第三方兜底。第三方聚合值不能覆盖链上或官方冲突，也不能在一手账本未闭合时冒充已核实 TTM。"
      },
      "null_reasons": {
        "income_statement": "The PRD permits HYPE Cash P/E only when protocol revenue and costs close; AF balances, entryNtl and HLP PnL are not substitutes for earnings.",
        "cash_flow": "经营现金流、资本开支与自由现金流不属于本轮协议 P/E 数据优化的强制覆盖范围。",
        "balance_sheet": "资产负债表需要另一套控制权与负债边界，本轮不强行补值。",
        "capital_returns": "持币者回报存在明确封锁的未闭合一手账本，不能以已知零值或第三方代理值代替。",
        "price_to_earnings": "缺少可用 Protocol Earnings。"
      }
    },
    {
